...
<div class="fieldcontain ${hasErrors(bean: tekMessageInstance, field: 'subject', 'error')} required">
	...
	<g:textField name="subject" required="" class="messageField" value="${tekMessageInstance?.subject}"/>
...
<div class="fieldcontain ${hasErrors(bean: tekMessageInstance, field: 'content', 'error')} required">
	...
	<g:textArea name="content" cols="40" rows="5" maxlength="2000" required="" class="messageField" value="${tekMessageInstance?.content}"/>
